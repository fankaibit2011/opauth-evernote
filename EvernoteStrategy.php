 ...
 */
class EverntoeStrategy extends OpauthStrategy{
  ...
  public $defaults = array(
    ...
    'authorize_url' => 'https://sandbox.evernote.com/oauth/OAuth.action',
    'access_token_url' => 'https://sandbox.evernote.com/oauth/oauth',
